...
**Sequencing flag:** these four satellites take the 21 & 28 July and 4 & 11 August Tuesday slots. Satellite 3 (grandmother's garden, Hardiness cluster) was provisionally eligible for the same window once the UK pillar had 2–3 weeks of Search Console data, which lands around 21–28 July. Defaulting to the Garden Cost cluster taking those two slots here, since better conversion is the explicit reason this work was commissioned, but this is Steen's call to resequence if Satellite 3 should jump back in front.

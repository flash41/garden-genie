...
You are not fooling anyone in a literal sense. But perception of space is genuinely subjective, and the conditions that create a feeling of generosity in a garden are well understood. The garden does not need to be bigger. It needs to be designed in a way that makes its size feel beside the point.

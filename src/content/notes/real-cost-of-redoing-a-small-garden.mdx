...
Every garden project, regardless of size, breaks into three broad buckets: **hard landscaping**, **soft landscaping**, and **labour**. The ratio between them varies wildly depending on what you're doing, but understanding these three separately changes how you think about a budget.
...
Set the number. Build the project around it. The garden you can actually afford to make is the one you'll actually make.

...
What we've found worth doing before committing to a planting plan is a basic soil assessment — texture, drainage behaviour after heavy rain, and a pH test if you're planning to grow anything with known preferences. It takes an hour and it saves years of disappointment.

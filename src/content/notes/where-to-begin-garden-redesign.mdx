...
Calm. [Wildness](/notes/pollinator-haven-garden-features). Somewhere for the kids to burn energy. A productive kitchen garden. A place that feels private from the road. Somewhere that works for evening drinks when the weather allows.
...
*If the anchor-zone framework above is enough to get you moving but you'd like a proper plan for what to actually put there, dedrab will produce one from a single photo. [Try it at dedrab.com](https://www.dedrab.com).*
